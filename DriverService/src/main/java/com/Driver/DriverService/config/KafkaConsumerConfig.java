...
public class KafkaConsumerConfig {
    @Bean
    public ConsumerFactory<String, RiderRequestEvent> consumerFactory(){
        ...
        return new DefaultKafkaConsumerFactory<>(configProps,new StringDeserializer(),new JsonDeserializer<>(RiderRequestEvent.class,false));
    }
    @Bean
